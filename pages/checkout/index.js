                        ...
                        <Container flexDir="column" justify="space-between" bor="1px solid var(--whiteGray)">
                            ...
                            <Container flexDir="column" justify="space-around">
                                <Container flexDir="row" justify="space-between" align="center" m="3% 0 1% 0">
                                    ...
                                    <TextP fontS=".9rem" fontW="700" col="var(--darkGray)">{subTotal}€</TextP>
                                </Container>
                                <Container flexDir="row" justify="space-between" align="center" m="1% 0 1% 0">
                                    ...
                                    <TextP fontS=".9rem" fontW="700" col="var(--darkGray)">{discount}€</TextP>
                                </Container>
                                <Container flexDir="row" justify="space-between" align="center" m="1% 0 1% 0">
                                ...
                                <Container flexDir="row" justify="space-between" align="center" m="1% 0 1% 0">
                                    ...
                                    <TextP fontS="1.3rem" fontW="800" col="var(--darkGray)">{total}€</TextP>
                                </Container>
                            </Container>
                    </Container>
                </Container>
                    ...
                    <Container flexDir="column" w="100%">
                        ...
                        <Container flexDir="column" w="100%">
                            <Container flexDir="row" w="100%">
                                ...
                                <Input placeholder="Valid thru" w="6rem" h="2rem" bor="1px solid var(--lightGray)" outL="none" bg="var(--whiteGray)" color="var(--darkGray)" borR="5px" m="2% 0 0 0" p="0 1%" fontS=".9rem"></Input>
                            </Container>
                            <Container flexDir="column" w="100%">
                                <Input placeholder="CCV" w="3.5rem" h="2rem" bor="1px solid var(--lightGray)" outL="none" bg="var(--whiteGray)" color="var(--darkGray)" borR="5px" m="2% 0 0 0" p="0 1%" fontS=".9rem"></Input>
                            </Container>
                        </Container>
                            <Button m="1.5% 0 0 0" fontS="1.5rem" fontW="400" bg="var(--darkGray)" col="var(--white)" w="16rem" justify="center" align="center" h="3.5rem" bor="1px solid var(--darkGray)" borR="5px" borH="1px solid var(--lightBurgundy)" bgH="var(--lightBurgundy)">Checkout</Button>
                            <TextH1 fontS="1rem" fontW="400" col="var(--darkGray)" m="2% 0 0 0">Tip: Click on the card to flip, information that you need is underlined.</TextH1>
                    </Container>
                    <Container bg="linear-gradient(to right,var(--rustOrange), var(--lightBurgundy))" flexDir="column" align="center" h="100%" borR="15px" m="2% 0 0 0" wSM="100%">
                        <Card>
